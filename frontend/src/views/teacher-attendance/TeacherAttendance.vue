        ...
        <div>
            ...
            <div class="d-flex px-5 gap-3">
                ...
                <button
                    ...
                    @click="viewAttendance">View Attendance </button>

                <button
                    class="btn btn-outline-primary"
                    @click="router.push('/attendance/summary')"
                >View Summary
...
const checkSelectedDate = async () => {
    ...
    try {
        ...
        if (selectedDate.value > currentDate) {
            ...
            errorMessage.value ="Attendance cannot be marked for a future date.";
            return;
        ...
        if (date.getDay() === 0) {
            ...
            attendanceBlocked.value = true;
            errorMessage.value = "Attendance cannot be marked. Sunday is a weekly off.";
            return;
        ...
        if (res.data.isBlocked) {
            ...
            if (res.data.type === "HOLIDAY") {
                errorMessage.value = `Attendance cannot be marked. It is a holiday: ${res.data.reason}`;
            }
            else if (
                res.data.type === "WEEKLY_OFF"
            ) {
                errorMessage.value =`Attendance cannot be marked. It is a weekly off: ${res.data.reason}`;
...
const markAttendance = () => {
    ...
    if (!selectedClass.value) {
        errorMessage.value = "Assigned class not found.";
        return;
    }
