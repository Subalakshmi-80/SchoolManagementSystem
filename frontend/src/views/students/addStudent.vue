<template>
    ...
    <div class="student-box">
        <h2 class="text-center text-success fw-bold">Add Student</h2>
...
<div class="d-flex justify-content-center align-items-center gap-3 buttons-group">
    ...
    <button
        ...
        type="button"
        @click="router.push('/student/list')"
    >
        Cancel
    </button>
</div>
