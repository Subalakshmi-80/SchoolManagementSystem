<template>
    <AdminNavbar>
        ...
        <div class="teacher-box">
            <h2 class="text-center text-success fw-bold fs-4">Add Teacher</h2>
            <h3 class="fs-6 text-secondary">Fill in the teacher details below.</h3>
            ...
            <form @submit.prevent="saveTeacher">
                ...
                <div class="form-group">
                    ...
                    <input type="password" v-model="teacher.password" required>
                </div>
        ...
        >
            {{ cls.standard.name }}-{{ cls.name }}
                ...
                <div class="d-flex justify-content-center align-items-center gap-3 button-group">
                    ...
                    <button class="btn btn-outline-success" type="submit">Save Teacher</button>
...
const saveTeacher = async()=>{
    try{
        ...
        const res = await API.post('/api/teacher',teacher.value,{
            headers:{
                Authorization:`Bearer ${token}`
            }
        })
