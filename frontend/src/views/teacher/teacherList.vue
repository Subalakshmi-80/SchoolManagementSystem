...
<template>
    ...
    <div>
         <div class="sm-row p-0 m-0 p-md-5 d-md-flex align-items-center justify-content-between" >

            
            
             <div class="col-12  col-md-4 d-flex justify-content-center justify-content-md-start mb-3 mb-md-0 gap-2">
    ...
    const filteredTeachers = computed(()=>{
        ...
        if(search.value.trim()!== ""){
            result = result.filter(teacher =>
                ...
                teacher.user.email.toLowerCase().includes(seatch.value.toLowerCase()) 
            )
        }
        return result;
    })
